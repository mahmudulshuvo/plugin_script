...
function loadWidget() {
  ...
  if (window.jQuery) {
    ...
    console.log("jQuery doesn't exists")
    addJquery()
  }
  addFontAwesome()
  ...
  getFundraiserLocalValue(url, slug)
  console.log('--------------- end execution---------------')
}

async function getFundraiserLocalValue(url, slug) {
  await fetch(url)
    .then(response => {
...
function setValues(result, slug) {
...
function addJquery() {
  console.log('add jquery function')
